...
def find_best_temp_and_cooling(full_connection_dict, possible_directions,
    ...
    for i in range(2):
        ...
        for a in range(random.randint(min_trains, max_trains)):
            current_trajectory, needed_connections_dict = create_annealing_steps_trajectory(station_locations,
    ...
    for temperature in temperature_values:
        ...
        for cooling_rate in cooling_rate_values:
            ...
            # use current temperature and cooling rate to improve all 1000 solutions
